...
export const OutputStderr: Component<OutputProps> = (props) => {
  return (
    <Show when={props.outputs?.stderr && props.outputs.stderr.length > 0}>
      <div class="flex flex-col gap-1 font-mono text-sm px-2 pb-2 pt-0 pl-1 border-foreground max-h-60 overflow-y-auto">
...
export const OutputError: Component<OutputProps> = (props) => {
  return (
    <Show when={props.outputs?.error}>
      <div class="flex flex-col gap-1 font-mono text-sm px-2 pb-2 pt-0 pl-1 border-foreground">
